...
export function create() {
  ...
  const root = parent || body;
  props && addProps(el, props, root);
  root && root.appendChild(el);
  const readyFunc = props && (props.func || props.callback || props.cb || props.ready);
  readyFunc && readyFunc(el);
...
*/
export function addProps(obj, o, root) {
